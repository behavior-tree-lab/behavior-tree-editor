...
- [Documentation](/docs/) — Concepts, node types and usage
- [Getting Started](/docs/getting-started) — Download and run the editor
...
This is a maintained fork of the original behavior3editor by Renato de Pontes Pereira. It merges long-pending community pull requests and modernizes the build (Electron, current Node tooling). See the [changelog](/docs/changelog) for details.
